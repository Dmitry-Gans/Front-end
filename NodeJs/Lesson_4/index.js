...
// npm i -g nodemon - библиотека для сервера, чтобы при изменении кода, каждый раз не перезапускать сервер, запускать файлы через команду nodemon имя файла, вместо node имя файла